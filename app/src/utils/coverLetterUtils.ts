...
class CoverLetterGenerator {
    ...
    async generateCoverLetter(resumeText: string, jobDescription: string, instructions: string): Promise<GeneratedCoverLetter> {
        const prompt = `
        ...
        try {
            console.log(`Generating cover letter with ${this.providerName} AI provider...`);
            ...
            console.error(`Error generating cover letter with ${this.providerName} AI provider:`, error);
            throw error;
        }
    }
}
